...
VALUES (10, '경기도 성남시 분당구', '경기도', '성남시 분당구', '', 127.423084873712, 37.0789561558879),
       (11, '서울특별시 강남구 압구정로', '서울특별시', '강남구', '압구정동', 127.044520, 37.543401),
       (12, '서울특별시 강남구 논현로', '서울특별시', '강남구', '논현동', 127.045630, 37.542890),
       (13, '서울특별시 강남구 강남대로', '서울특별시', '강남구', '역삼동', 127.043890, 37.544200),
       (14, '서울특별시 강남구 선릉로', '서울특별시', '강남구', '선릉동', 127.046710, 37.541900),
       (15, '서울특별시 강남구 테헤란로', '서울특별시', '강남구', '삼성동', 127.045200, 37.542500),
       (16, '서울특별시 강남구 봉은사로', '서울특별시', '강남구', '삼성동', 127.046800, 37.543100),
       (17, '서울특별시 강남구 압구정로32길', '서울특별시', '강남구', '압구정동', 127.042890, 37.544450),
       (18, '서울특별시 강남구 언주로', '서울특별시', '강남구', '압구정동', 127.043200, 37.542800),
       (19, '서울특별시 강남구 도산대로', '서울특별시', '강남구', '신사동', 127.044100, 37.543800),
       (20, '서울특별시 강남구 학동로', '서울특별시', '강남구', '논현동', 127.045900, 37.542100),
       (21, '서울특별시 강남구 압구정로42길', '서울특별시', '강남구', '압구정동', 127.043600, 37.544000),
       (22, '서울특별시 강남구 선릉로158길', '서울특별시', '강남구', '논현동', 127.046200, 37.542600),
       (23, '서울특별시 강남구 압구정로28길', '서울특별시', '강남구', '압구정동', 127.042100, 37.544600),
       (24, '서울특별시 강남구 언주로152길', '서울특별시', '강남구', '신사동', 127.043800, 37.543500),
       (25, '서울특별시 강남구 논현로32길', '서울특별시', '강남구', '논현동', 127.045100, 37.542300),
       (26, '서울특별시 강남구 압구정로30길', '서울특별시', '강남구', '압구정동', 127.042500, 37.544300),
       (27, '서울특별시 강남구 선릉로156길', '서울특별시', '강남구', '논현동', 127.047200, 37.541700),
       (28, '서울특별시 강남구 압구정로38길', '서울특별시', '강남구', '압구정동', 127.043400, 37.543900),
       (29, '서울특별시 강남구 도산대로45길', '서울특별시', '강남구', '신사동', 127.044800, 37.543200),
       (30, '서울특별시 강남구 언주로148길', '서울특별시', '강남구', '신사동', 127.044300, 37.542700),
       (31, '서울특별시 강남구 압구정로26길', '서울특별시', '강남구', '압구정동', 127.041800, 37.544800),
       (32, '서울특별시 강남구 논현로36길', '서울특별시', '강남구', '논현동', 127.045400, 37.542000),
       (33, '서울특별시 강남구 선릉로154길', '서울특별시', '강남구', '논현동', 127.046900, 37.541800),
       (34, '서울특별시 강남구 압구정로40길', '서울특별시', '강남구', '압구정동', 127.043100, 37.544100),
       (35, '서울특별시 강남구 도산대로47길', '서울특별시', '강남구', '신사동', 127.044500, 37.543600),
       (36, '서울특별시 강남구 언주로146길', '서울특별시', '강남구', '신사동', 127.043900, 37.543000),
       (37, '서울특별시 강남구 압구정로34길', '서울특별시', '강남구', '압구정동', 127.042800, 37.544200),
       (38, '서울특별시 강남구 논현로34길', '서울특별시', '강남구', '논현동', 127.045700, 37.541900),
       (39, '서울특별시 강남구 선릉로152길', '서울특별시', '강남구', '논현동', 127.047000, 37.541600);
...
INSERT INTO notifications (id, member_id, source_domain, source_id, event_type, content, status, read_at, created_at,
                           modified_at)
VALUES
-- 읽지 않은 알림들 (최신순)
(500, 1000, 'Waiting', 100, 'ENTER_NOW', '지금 매장으로 입장 부탁드립니다. 즐거운 시간 보내세요!', 'UNREAD', NULL, '2025-06-28T15:30:00',
 '2025-06-28T15:30:00'),
(501, 1000, 'Waiting', 100, 'ENTER_3TEAMS_BEFORE', '앞으로 3팀 남았습니다! 순서가 다가오니 매장 근처에서 대기해주세요!', 'UNREAD', NULL,
 '2025-06-28T15:00:00', '2025-06-28T15:00:00'),
(502, 1001, 'Waiting', 101, 'WAITING_CONFIRMED', '대기 등록이 완료되었습니다. 대기번호 2번으로 확정되었습니다.', 'UNREAD', NULL,
 '2025-06-28T14:30:00', '2025-06-28T14:30:00'),

-- 읽은 알림들
(504, 1000, 'Waiting', 100, 'WAITING_CONFIRMED', '대기 등록이 완료되었습니다. 대기번호 1번으로 확정되었습니다.', 'read', '2025-06-28T11:05:00',
 '2025-06-28T10:05:00', '2025-06-28T10:05:00'),
(505, 1001, 'Waiting', 101, 'ENTER_TIME_OVER', '입장 시간이 초과되어 대기가 취소되었습니다. 다음 기회에 다시 신청해주세요.', 'read',
 '2025-06-28T12:00:00', '2025-06-28T11:30:00', '2025-06-28T11:30:00'),
